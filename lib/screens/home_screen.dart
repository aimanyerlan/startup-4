...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    final recentItems = [
      {"name": "Organic Milk", "time": "2h ago"},
      {"name": "Whole Grain Bread", "time": "5h ago"},
      {"name": "Greek Yogurt", "time": "1d ago"},
    ];
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
                  // Action Card (Container, radius 28, shadow)
                  GestureDetector(
                    onTap: () {
                  ...
                  // Tools Grid (two Expanded Containers)
                  Row(
                    children: [
                      Expanded(
                  ...
                  // Recent Scans (horizontal list, height 180)
                  Row(
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final bgColors = [Color(0xFFE0F5F0), Color(0xFFEDE9F3), Color(0xFFE8F3FC)];
                        return Padding(
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(28),
                                // no shadow so borders won't appear
                              ),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Container(
                                    ...
                                    child: const Icon(Icons.local_drink, color: Colors.black54),
                                  ),
                                  const Spacer(),
                  ...
                  // Suggestions (vertical list of recipe cards)
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: const Icon(Icons.egg, color: Colors.black54),
                                ),
                                const SizedBox(width: 12),
                                Expanded(
                                  child: Column(
